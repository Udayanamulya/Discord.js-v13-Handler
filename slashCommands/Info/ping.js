...
module.exports = {
  ...
  description: "Gives The Information Of the bot", //the command description for Slash Command Overview
  cooldown: 1,
  ...
  run: async (client, interaction) => {
    try{
		...
		//Other Option is API so we are alright
		    ...
		    interaction.reply({content: `Dicord Api Ping: \`${Math.floor(client.ws.ping)} ms\``, ephemeral: true})
		}
    } catch (e) {
